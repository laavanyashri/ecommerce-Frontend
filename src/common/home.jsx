...
async function addproducts() {
  ...
  //let categorydata = await axios.get(`http://localhost:5000/api/categorybyname/${categoryname}`);
    let categorydata = await axios.get(`https://ecommerce-backend-e6j1.onrender.com/api/categorybyname/${categoryname}`);
  let productsdata = [{
  ...
  axios.post("https://ecommerce-backend-e6j1.onrender.com/api/products", productsdata).then((res) => {
