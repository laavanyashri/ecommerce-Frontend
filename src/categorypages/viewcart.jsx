...
const ViewCart = () => {
    ...
    const getCartItems = async () => {
        ...
        let cartitems = await axios.get(`https://ecommerce-backend-e6j1.onrender.com/api/getcartitems${userid}`);
       // let cartitems = await axios.get(`http://localhost:5000/api/getcartitems${userid}`);
        ...
        let productitems = await axios.get(`https://ecommerce-backend-e6j1.onrender.com/api/getproducts?${queryString}`);
    ...
    const updateCartItemUser =async(userid) =>
    {
        ...
        let updatedcart = await axios.post('https://ecommerce-backend-e6j1.onrender.com/api/updatecartuser',requestdata);
...
console.log("teh updateddat",updatedcart);
    ...
    const handleDelete = async(imageid) => {
        try {
            ...
            const response = await axios.delete(`https://ecommerce-backend-e6j1.onrender.com/api/updateImageFromCart/${imageid}`);
